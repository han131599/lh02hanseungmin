  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">트레이너 계정 정보를 관리하세요</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>기본 계정 정보를 관리하세요</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="text-sm text-gray-600">
            프로필 정보 수정 기능은 추후 업데이트 예정입니다.
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-red-200">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <h3 className="font-semibold text-sm">계정 삭제</h3>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription className="space-y-2">
                  ...
                  <p className="font-semibold">계정이 비활성화되며, 등록된 모든 회원 데이터에도 영향을 미칩니다.</p>
                </DialogDescription>
              </DialogHeader>
